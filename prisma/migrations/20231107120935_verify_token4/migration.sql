/*
  ...
  - You are about to drop the column `expiration` on the `verifytoken` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `verifytoken` DROP COLUMN `expiration`;
